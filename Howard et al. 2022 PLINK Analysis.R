#This script integrates SNP data from Howard et al. 2022, with the Jim Dunckley and Plant & Food Research samples to find duplicates with PLINK.
#JD_PFR genotype files are re-exported from Axiom to have matching SNPs, and the Howard 2022 data formatted as close to PLINK format as possible in Excel first, then saved as .txt.
